...
```{r}
#The workload in the first three weeks is quite heavy; the prepracticals are almost the same length as the practical, plus the content was quite challenging, which might scare some people off. Maybe it is possible to reduce the workload to an equal amount as the contents on structural equation models.
```
