...
```{r}
#it would be nice if there is perhaps a summary/cheatsheet collating the codes, output table interpretations and write-ups across the different models we learnt this year :)) but really appreciate all teaching team members' help overall!
```
