...
```{r}
#I think the lecture and practical could be somehow combined. When I am having the lecture, I am sometimes confused, until I get to trial out the codes in the practical.
```
